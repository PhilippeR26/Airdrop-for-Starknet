        ...
        <Box
          ...
          >
            ...
            <Link color="blue.700" href='https://starknetjs.com' isExternal> Starknet.js v6.17.0<ExternalLinkIcon mx='2px'></ExternalLinkIcon></Link>
             , <Link color="blue.700" href='https://github.com/PhilippeR26/starknetMerkleTree' isExternal> Starknet-merkle-tree v1.0.5<ExternalLinkIcon mx='2px'></ExternalLinkIcon></Link>,
